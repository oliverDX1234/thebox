...
export default {
    ...
    components: {VueEasyLightbox, PageHeader},
    data() {
        return {
            title: "Lightbox",
            items: [
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        >In this example lazy-loading of images is enabled for the next image based on move
                            direction.</p>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="button-items">
                                    <b-button v-b-modal.modal-1 class="mo-mb-2" variant="light">Open YouTube Video
                                    </b-button>
                                    <b-modal
                                    ...
                                    >
                                        <youtube video-id="RnDC9MXSqCY" ref="youtube" width="750"
                                                 height="450"></youtube>
                                    </b-modal>
