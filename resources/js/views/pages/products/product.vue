                                        ...
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Product Name"
                                                       v-model="product.basic_information.name"
                                                       type="text"
                                                       class="form-control"
                                            ...
                                            <div class="form-group">
                                                <b-form-checkbox v-model="product.basic_information.active" size="lg"
                                                                 switch
                                                                 class="mb-1">
                                                    <label>Active</label>
                                                </b-form-checkbox>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="metatitle" v-model="product.meta.title"
                                                               name="metatitle"
                                                               type="text"
                                                               class="form-control"
                                ...
                                <tab-content title="Preview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div v-if="product.basic_information.selectedSuppliers.length" class="col-4">
                                            <h6>Supplier</h6>
                                            <p class="mt-1 mb-3">{{
                                                    product.basic_information.selectedSuppliers.name
                                                }}</p>
                                        </div>
                                    </div>
                                    <hr>
